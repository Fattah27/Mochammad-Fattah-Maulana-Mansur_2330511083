    ...
    <div class="about-grid">
        <div class="about-stat">
            ...
            <div class="about-stat-label">
                Saya selalu berusaha memberikan dedikasi penuh dalam setiap pekerjaan. Dengan komitmen yang kuat terhadap kualitas, saya terus mendorong diri untuk belajar dan berkembang. Keinginan saya adalah mencapai hasil yang luar biasa, meskipun tantangan yang dihadapi cukup besar.
            </div>
        </div>
        <div class="about-stat">
            <div class="about-stat-number">Keahlian Teknologi</div>
            <div class="about-stat-label">
                Saya memiliki keahlian dalam berbagai teknologi digital, terutama dalam pengembangan perangkat lunak dan pengelolaan sistem informasi. Dengan kemampuan dalam bahasa pemrograman seperti Python dan JavaScript, saya juga memahami prinsip dasar keamanan jaringan yang sangat penting dalam dunia teknologi modern.
            </div>
        </div>
        <div class="about-stat">
            <div class="about-stat-number">Komitmen pada Komunitas</div>
            <div class="about-stat-label">
                Selain aktif dalam dunia akademik dan teknologi, saya juga berpartisipasi dalam berbagai inisiatif sosial dan proyek teknologi yang berdampak langsung kepada masyarakat. Pengalaman ini telah mengajarkan saya untuk bekerja dalam tim, berkolaborasi, dan berinovasi bersama untuk mencapai tujuan yang lebih besar.
            </div>
        </div>
    </div>
</section>
...
<section id="skills" class="section skills-section">
    ...
    <?php
        // Filter skill yang mengandung kata "linux"
        $skillsFiltered = [];
    ...
    <div class="skills-grid">
        <?php foreach ($skillsFiltered as $skill): ?>
            ...
            <?php
                ...
                // Cek apakah nama keahlian ada dalam array icon
            ...
            <article class="neon-card skill-card skill-item">
                <div class="skill-icon">
                    <i data-lucide="<?= $icon ?>"></i> <!-- Render icon -->
                </div>
...
<section id="projects" class="section">
    <h2 class="section-title mb-3">Fitur Web Project</h2>
    ...
    <footer class="footer">
        <p>© <?= date('Y') ?> <?= esc($biodata['nama']) ?> · Developer Enthusiast</p>
    </footer>
